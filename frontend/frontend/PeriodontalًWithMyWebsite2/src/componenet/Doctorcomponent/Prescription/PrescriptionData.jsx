...
export const PrescriptionData = () => {
    ...
    useEffect(() => {
        const fetchData = async () => {
            try {
                ...
                // جلب الوصفات الطبية
                const prescriptionsResponse = await fetch(`https://localhost:44320/api/Prescriptions/patient/${id}`);
    ...
    const handleDelete = async (prescriptionId) => {
        try {
            ...
            const response = await fetch(`https://localhost:44320/api/Prescriptions/${prescriptionId}`, {
                method: 'DELETE'
            });
