...
export const Patientoption = () => {
    ...
    useEffect(() => {
        const fetchData = async () => {
            try {
                // Fetch patient name
                const nameResponse = await fetch(`https://localhost:44320/api/Patients/${id}/name`);
                if (nameResponse.ok) {
                ...
                const summaryResponse = await fetch(`https://localhost:44320/api/patient-options/${id}/summary`);
