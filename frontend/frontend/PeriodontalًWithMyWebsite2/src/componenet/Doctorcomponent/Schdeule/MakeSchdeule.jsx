...
export const MakeSchdeule = () => {
    ...
    const doctorId = 1; // Replace with actual doctor ID from your auth system
    ...
    useEffect(() => {
        const loadSchedule = async () => {
            ...
            setError(null);
            try {
                const response = await fetch(`https://localhost:44320/api/schedule/available/${doctorId}`);
                if (!response.ok) {
    ...
    const handleSubmit = async () => {
        ...
        try {
            ...
            const response = await fetch('https://localhost:44320/api/schedule/set', {
                method: 'POST',
                headers: {
