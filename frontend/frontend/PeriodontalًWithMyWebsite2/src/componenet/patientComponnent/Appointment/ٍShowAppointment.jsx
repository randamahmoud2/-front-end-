...
const ShowAppointment = () => {
    ...
    useEffect(() => {
        const fetchAppointments = async () => {
            try {
                ...
                const response = await fetch(`https://localhost:44320/api/Appointments/patient/${patientId}`);
    ...
    const cancelAppointment = async (appointmentId) => {
        try {
            const response = await fetch(`https://localhost:44320/api/Appointments/${appointmentId}`, {
                method: 'DELETE'
            });
